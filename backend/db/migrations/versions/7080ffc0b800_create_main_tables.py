...
def create_users_table() -> None:
    op.create_table(
        ...
        sa.Column("citizens", sa.Text, nullable=False, index=True),
        sa.Column("duty_to_work", sa.Text, nullable=False, index=True, server_default="yes"),
        sa.Column("duty_status", sa.Text, nullable=False, index=True, server_default="do_not_get_in_touch"),
        sa.Column("grant_amount", sa.Integer, nullable=False, index=True),
        sa.Column("duty_period", sa.Integer, nullable=False, index=True),
        sa.Column("company", sa.Text, nullable=False, index=True),
        sa.Column("resume_path", sa.Text, nullable=False, index=True),
        ...
        sa.Column("salary", sa.Integer, nullable=False, index=True),
        sa.Column("working_reference_path", sa.Text, nullable=False, index=True),
        sa.Column("ndfl1_path", sa.Text, nullable=False, index=True),
        sa.Column("ndfl2_path", sa.Text, nullable=False, index=True),
        sa.Column("ndfl3_path", sa.Text, nullable=False, index=True),
        sa.Column("ndfl4_path", sa.Text, nullable=False, index=True)
    )
